    ...
    case groups_manager:filter_stream_leaf_id(FinalStream, Tree, NLeaves, MyId, Groups, Paths) of
        ...
        {ok, Stream, Id} ->
            TaggedStream = case is_list(Stream) of
                true -> [{
                    Label,
                    <<6,170,31, 32,16,10,9,108,111,99,97,108,104,111,115,116,16,170,31,32,16,10,9,108,111, 6,170,31, 32,16,10,9,108,111,99,97,108,104,111,115,116,16,170,31,32,16,10,9,108,111>>
                } || Label <- Stream];
                false -> lol
            end,
