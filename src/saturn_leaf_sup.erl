...
init(_Args) ->
    ...
    PractiPropagatorSup = {practi_propagation_fsm_sup,
                    {practi_propagation_fsm_sup, start_link, []},
                    permanent, 5000, supervisor, [practi_propagation_fsm_sup]},
    Childs0 = [ProxyMaster, PropagatorSup, PractiPropagatorSup],
